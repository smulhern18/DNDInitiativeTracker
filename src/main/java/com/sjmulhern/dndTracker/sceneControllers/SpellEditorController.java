...
public class SpellEditorController {
    ...
    public void saveButtonPressed (ActionEvent actionEvent) {
        App.initativeRoundRobin.getCurrent().setSpells(new Spells(new ArrayList<>(cantripTable.getItems()),
    ...
    private Spells result = new Spells(new ArrayList<>(),
                                       new ArrayList<>(),
                                       new ArrayList<>(),
                                       new ArrayList<>(),
                                       new ArrayList<>(),
    ...
    public void initialize() {
        ...
        firstSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult
            .getSlots().add(1, newValue)));
        initializeSpinner(secondSlots, slots.get(2));
        secondSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult
            .getSlots().add(2, newValue)));
        initializeSpinner(thirdSlots, slots.get(3));
        thirdSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlots().add(3, newValue)));
        initializeSpinner(forthSlots, slots.get(4));
        forthSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlots().add(4, newValue)));
        initializeSpinner(fifthSlots, slots.get(5));
        fifthSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlots().add(5, newValue)));
        initializeSpinner(sixthSlots, slots.get(6));
        sixthSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlots().add(6, newValue)));
        initializeSpinner(seventhSlots, slots.get(7));
        seventhSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlots().add(7, newValue)));
        initializeSpinner(eighthSlots, slots.get(8));
        eighthSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlots().add(8, newValue)));
        initializeSpinner(ninthSlots, slots.get(9));
        ninthSlots.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlots().add(9, newValue)));
        initializeSpinner(firstSlotsExpended, slotsExpended.get(1));
        firstSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(1, newValue)));
        initializeSpinner(secondSlotsExpended, slotsExpended.get(2));
        secondSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(2, newValue)));
        initializeSpinner(thirdSlotsExpended, slotsExpended.get(3));
        thirdSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(3, newValue)));
        initializeSpinner(forthSlotsExpended, slotsExpended.get(4));
        forthSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(4, newValue)));
        initializeSpinner(fifthSlotsExpended, slotsExpended.get(5));
        fifthSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(5, newValue)));
        initializeSpinner(sixthSlotsExpended, slotsExpended.get(6));
        sixthSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(6, newValue)));
        initializeSpinner(seventhSlotsExpended, slotsExpended.get(7));
        seventhSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(7, newValue)));
        initializeSpinner(eighthSlotsExpended, slotsExpended.get(8));
        eighthSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(8, newValue)));
        initializeSpinner(ninthSlotsExpended, slotsExpended.get(9));
        ninthSlotsExpended.getValueFactory().valueProperty().addListener(((observable, oldValue, newValue) -> finalResult.getSlotsUsed().add(9, newValue)));
        ...
        cantripEffect.setOnEditCommit(
            event -> (event.getTableView().getItems().get(event.getTablePosition().getRow())).setEffect(event.getNewValue())
        );
        ...
        cantripSize.setOnEditCommit(
            event -> (event.getTableView().getItems().get(event.getTablePosition().getRow())).setSize(event.getNewValue())
        );
        ...
        cantripShape.setOnEditCommit(
            event -> (event.getTableView().getItems().get(event.getTablePosition().getRow())).setShape(event.getNewValue())
        );
        ...
        cantripRequirements.setOnEditCommit(
            event -> (event.getTableView().getItems().get(event.getTablePosition().getRow())).setRequirements(event.getNewValue())
        );
    ...
    public Tab cantrips;
    @FXML
    public TableView<Spell> cantripTable;
    @FXML
    public TableColumn<Spell, String> cantripName;
    @FXML
    public TableColumn<Spell, String> cantripEffect;
    @FXML
    public TableColumn<Spell, Integer> cantripSize;
    @FXML
    ...
    @FXML
    public TableView<Spell> firstTable;
    @FXML
    public TableColumn<Spell, String> firstName;
    @FXML
    public TableColumn<Spell, String> firstEffect;
    @FXML
    public TableColumn<Spell, Integer> firstSize;
    @FXML
    public TableColumn<Spell, Shape> firstShape;
    @FXML
    public TableColumn<Spell, String> firstRequirements;
    @FXML
    public Spinner<Integer> firstSlots;
    @FXML
    public Spinner<Integer> firstSlotsExpended;
    @FXML
    public Tab secondLevel;
    @FXML
    public TableView<Spell> secondTable;
    @FXML
    public TableColumn<Spell, String> secondName;
    @FXML
    public TableColumn<Spell, String> secondEffect;
    @FXML
    public TableColumn<Spell, Integer> secondSize;
    @FXML
    public TableColumn<Spell, Shape> secondShape;
    @FXML
    public TableColumn<Spell, String> secondRequirements;
    @FXML
    public Spinner<Integer> secondSlots;
    @FXML
    public Spinner<Integer> secondSlotsExpended;
    @FXML
    public Tab thirdLevel;
    @FXML
    public TableView<Spell> thirdTable;
    @FXML
    public TableColumn<Spell, String> thirdName;
    @FXML
    public TableColumn<Spell, String> thirdEffect;
    @FXML
    public TableColumn<Spell, Integer> thirdSize;
    @FXML
    public TableColumn<Spell, Shape> thirdShape;
    @FXML
    public TableColumn<Spell, String> thirdRequirements;
    @FXML
    public Spinner<Integer> thirdSlots;
    @FXML
    public Spinner<Integer> thirdSlotsExpended;
    @FXML
    public Tab forthLevel;
    @FXML
    public TableView<Spell> forthTable;
    @FXML
    public TableColumn<Spell, String> forthName;
    @FXML
    public TableColumn<Spell, String> forthEffect;
    @FXML
    public TableColumn<Spell, Integer> forthSize;
    @FXML
    public TableColumn<Spell, Shape> forthShape;
    @FXML
    public TableColumn<Spell, String> forthRequirements;
    @FXML
    public Spinner<Integer> forthSlots;
    @FXML
    public Spinner<Integer> forthSlotsExpended;
    @FXML
    public Tab fifthLevel;
    @FXML
    public TableView<Spell> fifthTable;
    @FXML
    public TableColumn<Spell, String> fifthName;
    @FXML
    public TableColumn<Spell, String> fifthEffect;
    @FXML
    public TableColumn<Spell, Integer> fifthSize;
    @FXML
    public TableColumn<Spell, Shape> fifthShape;
    @FXML
    public TableColumn<Spell, String> fifthRequirements;
    @FXML
    public Spinner<Integer> fifthSlots;
    @FXML
    public Spinner<Integer> fifthSlotsExpended;
    @FXML
    public Tab sixthLevel;
    @FXML
    public TableView<Spell> sixthTable;
    @FXML
    public TableColumn<Spell, String> sixthName;
    @FXML
    public TableColumn<Spell, String> sixthEffect;
    @FXML
    public TableColumn<Spell, Integer> sixthSize;
    @FXML
    public TableColumn<Spell, Shape> sixthShape;
    @FXML
    public TableColumn<Spell, String> sixthRequirements;
    @FXML
    public Spinner<Integer> sixthSlots;
    @FXML
    public Spinner<Integer> sixthSlotsExpended;
    @FXML
    public Tab seventhLevel;
    @FXML
    public TableView<Spell> seventhTable;
    @FXML
    public TableColumn<Spell, String> seventhName;
    @FXML
    public TableColumn<Spell, String> seventhEffect;
    @FXML
    public TableColumn<Spell, Integer> seventhSize;
    @FXML
    public TableColumn<Spell, Shape> seventhShape;
    @FXML
    public TableColumn<Spell, String> seventhRequirements;
    @FXML
    public Spinner<Integer> seventhSlots;
    @FXML
    public Spinner<Integer> seventhSlotsExpended;
    @FXML
    public Tab eighthLevel;
    @FXML
    public TableView<Spell> eighthTable;
    @FXML
    public TableColumn<Spell, String> eighthName;
    @FXML
    public TableColumn<Spell, String> eighthEffect;
    @FXML
    public TableColumn<Spell, Integer> eighthSize;
    @FXML
    public TableColumn<Spell, Shape> eighthShape;
    @FXML
    public TableColumn<Spell, String> eighthRequirements;
    @FXML
    public Spinner<Integer> eighthSlots;
    @FXML
    public Spinner<Integer> eighthSlotsExpended;
    @FXML
    public Tab ninthLevel;
    @FXML
    public TableView<Spell> ninthTable;
    @FXML
    public TableColumn<Spell, String> ninthName;
    @FXML
    public TableColumn<Spell, String> ninthEffect;
    @FXML
    public TableColumn<Spell, Integer> ninthSize;
    @FXML
    public TableColumn<Spell, Shape> ninthShape;
    @FXML
    public TableColumn<Spell, String> ninthRequirements;
    @FXML
    public Spinner<Integer> ninthSlots;
    @FXML
    public Spinner<Integer> ninthSlotsExpended;
    @FXML
    public Button addSpellButton;
    @FXML
    public Button removeSelected;
    @FXML
    public ComboBox<String> spellNameComboBox;
